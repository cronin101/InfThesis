...
The bitonic mergesort kernel, generated and dispatched for all RubiCL's \verb|sort| tasks, was adapted from sample code for sorting provided within the \ac{AMD} APP SKD.
