...
\subsubsection{Smaller scale Map tasks}
\begin{figure}[H]
...
\subsubsection{Smaller scale dense Filter tasks}
\begin{figure}[H]
...
\subsubsection{Smaller scale sparse Filter tasks}
\begin{figure}[H]
...
\subsubsection{Smaller scale MapFilter tasks}
\begin{figure}[H]
